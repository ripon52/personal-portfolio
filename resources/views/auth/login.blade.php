...
<head>
    ...
    .authincation-content {
        background-color: #680323 !important;
    }
    </style>
</head>
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <div class="text-center mb-3">
                                        <a href="#"><img src="{{ asset('template/logo.png') }}" alt=""></a>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="email" autofocus type="email"
                                                ...
                                                value="{{ old('email') ?? 'rislam252@gmail.com' }}" required
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="password" type="password"
                                                ...
                                                value="12312352" name="password" required
                                    ...
                                    <div class="new-account mt-3">
                                        <p class="text-white">Don't have an account? <a class="text-white" href="#">Sign
                                                up</a></p>
                                    </div>
