            ...
            <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-8 d-none d-sm-block">
                            <div class="topbar-info">
                                <a href="tel:+8809638144413"><i class=" fa-2x fa fa-phone"></i>Call Us Now:
                                    + 88 0963 81444 13</a>
                                <span>/</span>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="topbar-links">
                                <a href="{{ url('/login') }}"><i class=" fa-2x fa fa-lock"></i>Login</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default">
                            ...
                            <div class="collapse navbar-collapse hidden-sm hidden-xs">
                                <ul class="nav navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a data-toggle="dropdown" class="nav-link dropdown-toggle" href="books-media-list-view.html">Books</a>
                    ...
                    <div class="mobile-menu d-lg-none">
                        <a href="#mobile-menu"><i class=" fa-2x fa fa-navicon"></i></a>
                        <div id="mobile-menu">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li> <a href="books-media-list-view.html"> Books  List  </a>  </li>
                                        <li><a href="books-media-gird-view.html">  PDF Books </a></li>
                                    </ul>
                                </li>
            ...
            <div class="carousel-item {{ $loop->iteration == 1 ? 'active' : '' }}">
                ...
                <div class="carousel-caption" data-aos="fade-down">
                    ...
                    <div class="slide-buttons hidden-sm hidden-xs">
                        <a href="{{ url('/login') }}" class="btn btn-primary">Get Started Now!<span></span></a>
                    </div>
                </div>
            </div>
        @empty
        ...
        <div class="title-content text-center" data-aos="fade-up">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <h6 class="sub-title">Welcome to the EAST DELTA UNIVERSITY</h6>
                    <h2 class="section-title">Welcome to the EDU LIBRARY</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="welcome-image" data-aos="fade-up-right">
                    <img src="{{ asset('front/images') }}/welcomeedu.png" class="algin-right" alt="">
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <ul>
                        ...
                        <li class="bg-purple">
                            <div class="fact-item">
                                ...
                                <span>PDF Book<strong class="fact-counter">32450</strong></span>
                            </div>
                        </li>
                ...
                <div class="welcome-wrap" data-aos="fade-down">
                    <div class="welcome-text">
                        <p>
                            ...
                            .</p>
                        <a class="btn btn-primary" href="{{ url('login') }}">Free Join Now<span></span></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="category-filter section-padding">
        ...
        <div class="title-content" data-aos="fade-up">
            <div class="row">
                <div class="col-md-8 text-center mx-auto">
                    <h6 class="sub-title">Latest Collections</h6>
                    <h2 class="section-title">Checkout New Releases <br /> Of Books</h2>
                </div>
            </div>
        </div>
        <div class="row text-center" data-aos="flip-left">
            <div class="col-sm-12">
                <div class="filter-buttons">
                    ...
                    @forelse(\App\Department::query()->orderBy('name')->get() as $department)
                        <div class="filter btn active " data-filter=".department{{$department->id}}">{{ $department->name }} ({{ $department->books->count() }})</div>
                    @empty
    ...
    <div id="category-filter">
        <ul class="category-list">
            @forelse(\App\Book::query()->orderBy('title')->get() as $book)
                    ...
                    <figure style="height: 329px;width: 409px;border: 2px solid maroon;border-radius: 75% 25% 39% 61% / 50% 12% 25% 33%;">
                        ...
                        <figcaption class="bg-black">
                            <div class="info-block">
                                <ol>
                                    ...
                                    <li>
                                        <a href="https://www.facebook.com/" target="_blank">
                                            <i class=" fa-2x fa fa-share-alt"></i>
                                        </a>
                                    </li>
                                ...
                                <a href="#">Available <i class=" fa-2x fa fa-long-arrow-right"></i> {{ $book->stock  }} </a>
                            </div>
                        </figcaption>
                    </figure>
                </li>
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="team-member first-member-box" data-aos="fade-down">
                        ...
                        <div class="content-block bottom-left-rounded">
                            <div class="member-info" style="padding:66px 36px!important">
                    ...
                    <div class="team-member second-member-box" data-aos="fade-right">
                        <div class="content-block">
                            <div class="member-info">
                                ...
                                <span class="designation">Graphics Designer & Web Developer</span>
                                <ul class="social">
                                    <li>
                                        <a href="#" target="_blank">
                                            <i class=" fa-2x fa fa-linkedin"></i>
                    ...
                    <article>
                        <div class="post-detail">
                            <div class="info-bar">
                                <div class="comments">
                                    <a href="#">
                                        <i class=" fa-2x fa fa-comment"></i> 37
                                    </a>
                                </div>
                                <div class="likes">
                                    <a href="#">
                                        <i class=" fa-2x fa fa-thumbs-o-up"></i> 110
                                    </a>
                                </div>
                                <div class="viewed">
                                    <a href="#">
                                        <i class=" fa-2x fa fa-eye"></i> 180
                                    </a>
                                </div>
                                <div class="share">
                                    <a href="#">
                                        <i class=" fa-2x fa fa-share-alt"></i> Share
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="author">
                                <a href="#">
                                    <i class=" fa-2x fa fa-user"></i> Adrey Pachai
                                </a>
                            </div>
                        ...
                        <figure>
                            <img src="{{ asset('front/images') }}/mir01.jpg" alt="Latest Blog">
                            <figcaption>
                                <a href="#">
            ...
            @forelse(reviews() as $review)
                <div class="single-testimonial-box" data-aos="{{ $loop->iteration == 1 ? 'fade-left' : 'fade-right' }} ">
                    <div class="top-portion">
                        <img src="{{ !empty($review->user->avatar) ?  asset('project_files/student/'.$review->user->avatar) : asset('front/images/testimonial-image-01.jpg') }}" alt="Testimonial Image" />
                        <div class="user-comment">
                            <div class="arrow-left"></div>
                            <blockquote cite="#">
                                {{ $review->comments }}
                                <br>
                               <b>[ Book : {{ $review->book ? $review->book->title : 'N/A' }} ]</b>
                            </blockquote>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="bottom-portion">
                        ...
                        <div class="social-share-links">
                            <ul>
                                <li><a href="#"><i class=" fa-2x fa fa-linkedin" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class=" fa-2x fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class=" fa-2x fa fa-twitter" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class=" fa-2x fa fa-skype" aria-hidden="true"></i></a></li>
                                <li><a href="#"><i class=" fa-2x fa fa-google-plus" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="row w-100">
                ...
                <div class="col-lg-3 col-md-6 widget-container">
                    <div class="widget twitter-widget">
                        ...
                        <address>
                            <div class="info">
                                <i class=" fa-2x fa fa-location-arrow"></i>
